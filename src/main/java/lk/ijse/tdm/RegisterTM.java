...
public class RegisterTM {
    ...
    public RegisterTM(String adminName, String adminPossision, String adminNic, String EMail, String password, String confirmPassword, String contact, String admin_Code) {
        AdminName = adminName;
