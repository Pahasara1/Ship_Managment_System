...
public class DailyReportsTM {
    private String ReportId;
    private String EmployeeNic;
    private String TemperatureLevel;
    private String MachineRunning;

    public DailyReportsTM() {
    }

    public DailyReportsTM(String reportId, String employeeNic, String temperatureLevel, String machineRunning) {
        ReportId = reportId;
